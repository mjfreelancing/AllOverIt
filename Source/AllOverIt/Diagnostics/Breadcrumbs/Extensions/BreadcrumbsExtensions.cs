...
namespace AllOverIt.Diagnostics.Breadcrumbs.Extensions
{
    ...
    public static class BreadcrumbsExtensions
    {
        ...
        public static void AddCallSite(this IBreadcrumbs breadcrumbs, object caller, object metadata = default, string tag = default,
            [CallerMemberName] string callerName = "")
        {
            ...
            AddBreadcrumb(breadcrumbs, caller, message, metadata, tag, callerName);
        }
        ...
        public static void AddExtendedCallSite(this IBreadcrumbs breadcrumbs, object caller, object metadata = default, string tag = default,
            [CallerMemberName] string callerName = "",
            ...
            [CallerLineNumber] int lineNumber = 0)
        {
            ...
            AddBreadcrumb(breadcrumbs, caller, message, metadata, tag, callerName, filePath, lineNumber);
        }

        /// <summary>Adds a message to the collection of breadcrumbs.</summary>
        /// <param name="breadcrumbs">The breadcrumbs to add the data too.</param>
        /// <param name="message">The message to be added.</param>
        public static void Add(this IBreadcrumbs breadcrumbs, string message, string tag = default)
        {
            _ = breadcrumbs.WhenNotNull(nameof(breadcrumbs));
            _ = message.WhenNotNullOrEmpty(nameof(message));

            AddBreadcrumb(breadcrumbs, null, message, null, tag, null);
        }
        ...
        /// <param name="message">The message to be added.</param>
        /// <param name="metadata">Metadata associated with the message.</param>
        public static void Add(this IBreadcrumbs breadcrumbs, string message, object metadata, string tag = default)
        {
            _ = breadcrumbs.WhenNotNull(nameof(breadcrumbs));
            _ = message.WhenNotNullOrEmpty(nameof(message));
            _ = metadata.WhenNotNull(nameof(metadata));

            AddBreadcrumb(breadcrumbs, null, message, metadata, tag, null);
        }
        ...
        /// <param name="filePath">The file path of the calling method.</param>
        /// <param name="lineNumber">The line number of the calling method file path.</param>
        public static void Add(this IBreadcrumbs breadcrumbs, object caller, string message, string tag = default,
            [CallerMemberName] string callerName = "",
            [CallerFilePath] string filePath = "",
            [CallerLineNumber] int lineNumber = 0)
        {
            ...
            AddBreadcrumb(breadcrumbs, caller, message, null, tag, callerName, filePath, lineNumber);
        }
        ...
        internal static void AddBreadcrumb(IBreadcrumbs breadcrumbs, object caller, string message, object metadata,
            string tag, string callerName, string filePath = null, int lineNumber = 0)
        {
