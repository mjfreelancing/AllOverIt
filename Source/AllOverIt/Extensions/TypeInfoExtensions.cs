...
namespace AllOverIt.Extensions
{
    ...
    public static class TypeInfoExtensions
    {
        ...
        /// (if a property is overiden then only the base class <see cref="PropertyInfo"/> is returned).
        ...
        /// <remarks>When class inheritance is involved, this method returns the first property found, starting at the type represented
        /// by <paramref name="typeInfo"/>. If the property is overiden, this means the base class <see cref="PropertyInfo"/> will not be
        ...
        /// <param name="declaredOnly">If true, the metadata of properties in the declared class as well as base class(es) are returned
        /// (if a field is overiden then only the base class <see cref="FieldInfo"/> is returned).
