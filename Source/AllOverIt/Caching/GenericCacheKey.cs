namespace AllOverIt.Caching
{
    ...
    {
        /// <summary>The value of the key. A <see langword="null"/> value is allowed.</summary>
        public TKey1? Key1 { get; init; }

        /// <summary>Constructor.</summary>
        /// <param name="key1">The key value. A <see langword="null"/> value is allowed.</param>
        ...
        // There is no de-constructor as it requires two or more values
    }
    ...
    public record GenericCacheKey<TKey1, TKey2> : GenericCacheKeyBase
    {
        ...
        /// <summary>Constructor.</summary>
        /// <param name="key1">The first key value. A <see langword="null"/> value is allowed.</param>
        /// <param name="key2">The second key value. A <see langword="null"/> value is allowed.</param>
    ...
    public record GenericCacheKey<TKey1, TKey2, TKey3> : GenericCacheKeyBase
    {
        ...
        /// <param name="key1">The first key value. A <see langword="null"/> value is allowed.</param>
        /// <param name="key2">The second key value. A <see langword="null"/> value is allowed.</param>
        /// <param name="key3">The third key value. A <see langword="null"/> value is allowed.</param>
    ...
    public record GenericCacheKey<TKey1, TKey2, TKey3, TKey4> : GenericCacheKeyBase
    {
        ...
        /// <param name="key2">The second key value. A <see langword="null"/> value is allowed.</param>
        /// <param name="key3">The third key value. A <see langword="null"/> value is allowed.</param>
        /// <param name="key4">The fourth key value. A <see langword="null"/> value is allowed.</param>
