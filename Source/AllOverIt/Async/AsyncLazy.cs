...
namespace AllOverIt.Async
{
    ...
    {
        /// <summary>Initializes a new instance of the AsyncLazy{TType} class. When lazy initialization occurs, the specified initialization
        /// factory is executed asynchronously.</summary>
        ...
        /// <summary>Gets an awaiter that allows for 'await lazyProp' instead of 'await lazyProp.Value'</summary>
