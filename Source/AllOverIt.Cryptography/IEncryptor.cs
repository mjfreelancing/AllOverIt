namespace AllOverIt.Cryptography
{
    ...
    public interface IEncryptor
    {
        ...
        /// <summary>Decrypts a byte array containing the 'plain text' to another byte array that will be populated with the 'cipher text'.</summary>
        /// <param name="plainText">The byte array containing the 'cipher text'.</param>
