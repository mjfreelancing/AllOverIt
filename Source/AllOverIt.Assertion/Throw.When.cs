...
namespace AllOverIt.Assertion
{
    ...
    public static partial class Throw<TException> where TException : Exception
    {
        ...
        public static void When<TExceptionArg1>([DoesNotReturnIf(true)] bool condition, Func<TExceptionArg1> arg1)
        {
            if (condition)
            {
        ...
        public static void When<TExceptionArg1, TExceptionArg2>([DoesNotReturnIf(true)] bool condition, Func<(TExceptionArg1 arg1, TExceptionArg2 arg2)> args)
        {
            if (condition)
            {
        ...
        public static void When<TExceptionArg1, TExceptionArg2, TExceptionArg3>([DoesNotReturnIf(true)] bool condition,
