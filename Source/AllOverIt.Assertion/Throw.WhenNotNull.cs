namespace AllOverIt.Assertion
{
    public static partial class Throw<TException> where TException : Exception
    {
        ...
        public static void WhenNotNull<TType, TExceptionArg1>(TType? @object, Func<TExceptionArg1> arg1)
            where TType : class
        {
            if (IsNotNull(@object))
            {
        ...
        public static void WhenNotNull<TType, TExceptionArg1, TExceptionArg2>(TType? @object, Func<(TExceptionArg1 arg1, TExceptionArg2 arg2)> args)
            where TType : class
        {
            if (IsNotNull(@object))
            {
        ...
        public static void WhenNotNull<TType, TExceptionArg1, TExceptionArg2, TExceptionArg3>(TType? @object, TExceptionArg1 arg1,
        ...
        public static void WhenNotNull<TType, TExceptionArg1, TExceptionArg2, TExceptionArg3>(TType? @object,
        ...
        public static void WhenNotNull<TType, TExceptionArg1, TExceptionArg2, TExceptionArg3, TExceptionArg4>(TType? @object, TExceptionArg1 arg1,
        ...
        public static void WhenNotNull<TType, TExceptionArg1, TExceptionArg2, TExceptionArg3, TExceptionArg4>(TType? @object,
