...
namespace AllOverIt.Assertion
{
    ...
    public static partial class Throw<TException> where TException : Exception
    {
        ...
        public static void WhenNullOrEmpty<TExceptionArg1>([NotNull] string? @object, Func<TExceptionArg1> arg1)
        {
            if (IsNullOrEmpty(@object))
            {
        ...
        public static void WhenNullOrEmpty<TExceptionArg1, TExceptionArg2>([NotNull] string? @object, Func<(TExceptionArg1 arg1, TExceptionArg2 arg2)> args)
        {
            if (IsNullOrEmpty(@object))
            {
        ...
        public static void WhenNullOrEmpty<TExceptionArg1, TExceptionArg2, TExceptionArg3>([NotNull] string? @object, TExceptionArg1 arg1,
        ...
        public static void WhenNullOrEmpty<TExceptionArg1, TExceptionArg2, TExceptionArg3>([NotNull] string? @object,
        ...
        public static void WhenNullOrEmpty<TExceptionArg1, TExceptionArg2, TExceptionArg3, TExceptionArg4>([NotNull] string? @object,
