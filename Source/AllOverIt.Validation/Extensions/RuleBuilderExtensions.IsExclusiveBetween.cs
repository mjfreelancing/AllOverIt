...
namespace AllOverIt.Validation.Extensions
{
    ...
    {
        /// <summary>Defines a validator on the current rule builder that will fail if the value of the property
        /// is outside the exclusive range. The error code is set to <see cref="ValidationErrorCode.OutOfRange"/>.</summary>
        ...
        /// <summary>Defines a validator on the current rule builder that will fail if the value of the property
        /// is outside the specified range. The error code is set to <see cref="ValidationErrorCode.OutOfRange"/>.</summary>
        /// <typeparam name="TType">The model type containing the property to be validated.</typeparam>
        /// <typeparam name="TProperty">The property type.</typeparam>
        /// <param name="ruleBuilder">The rule builder.</param>
        /// <param name="from">The lower limit of the exclusive range.</param>
        ...
        /// <summary>Defines a validator on the current rule builder that will fail if the value of the property
        /// is outside the exclusive range provided by resolvers that have access to the root context data.
