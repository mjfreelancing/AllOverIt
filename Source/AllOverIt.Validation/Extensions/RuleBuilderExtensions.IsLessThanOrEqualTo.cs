...
namespace AllOverIt.Validation.Extensions
{
    ...
    {
        /// <summary>Defines a validator on the current rule builder that will fail if the value of the property is less than
        /// or equal to a specified value. The error code is set to <see cref="ValidationErrorCode.OutOfRange"/>.</summary>
        ...
        /// <summary>Defines a validator on the current rule builder that will fail if the value of the property is less than
        /// or equal to the value provided by a resolver that has access to the root context data.
        ...
        {
            return ruleBuilder
                .SetValidator(new LessThanOrEqualToContextValidator<TType, TProperty, TContext>(valueResolver))
                .WithErrorCode(ValidationErrorCode.OutOfRange);
        }

        /// <summary>Defines a validator on the current rule builder that will fail if the value of the property is less
        /// than or equal to the value provided by a resolver that has access to the root context data.
        /// The error code is set to <see cref="ValidationErrorCode.OutOfRange"/>.</summary>
        /// <typeparam name="TType">The model type containing the property to be validated.</typeparam>
        /// <typeparam name="TProperty">The property type.</typeparam>
        /// <typeparam name="TContext">The root context type.</typeparam>
