    ...
    public static IHostBuilder CreateHostBuilder(string[] args)
    {
        ...
        return GenericHost
            ...
            .ConfigureServices((hostContext, services) =>
            {
                ...
                // Demonstrates using IValidationInvoker
                _ = services.AddValidationInvoker(validationRegistry =>
                {
                    validationRegistry.AutoRegisterValidators<ValidationRegistrar>((modelType, validatorType) =>
                    {
                        return modelType == typeof(Person);
                    });
                });
