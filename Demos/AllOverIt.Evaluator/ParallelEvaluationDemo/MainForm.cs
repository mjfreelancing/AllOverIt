...
namespace ParallelEvaluation
{
    public partial class FrmMain : Form
    {
        ...
        [
            new("sin(x)", "cos(y)", "sqrt(x*y)^3"),
            new("128*sin(3.14*(x)+3.14)", "192*sin(3.14*(y)+3.14/3-3*3.14/2)", "256*sin(3.14*(x*y)+3.14/5-5*3.14/2)"),
            new("log10(x)", "log(x*y)", "exp(x^2-y^2)"),
            new("cos(x)", "tan(x*y)", "sin(x^2-y^2)"),
            new("(x^2)%(y+1)", "y%(x+1)", "x%(y+1)"),
            new("cos(x/3.14)", "tan(x*3.14/180*y)", "sin(x^2-y^2)"),
            new("sin(x)", "cos(y)", "tanh(x^2/y^2)")
        ];
