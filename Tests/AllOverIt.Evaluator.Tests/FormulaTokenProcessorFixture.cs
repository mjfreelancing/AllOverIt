...
//        private readonly Fake<IFormulaExpressionFactory> _expressionFactoryFake;
//        private readonly Fake<IArithmeticOperationFactory> _operationFactoryFake;
//        private readonly Fake<IEvaluatorStack<string>> _operatorsFake;
//        private readonly Fake<IEvaluatorStack<Expression>> _expressionsFake;
//        private readonly bool _isUserDefined;

//        public FormulaTokenProcessorFixture()
//        {
//            this.UseFakeItEasy();

//            _isUserDefined = Create<bool>();

//            _tokenProcessorsFake = new Fake<IList<FormulaTokenProcessorContext>>();
//            _formulaReaderFake = new Fake<IFormulaReader>();
//            _formulaProcessorFake = new Fake<IFormulaProcessor>();
//            _expressionFactoryFake = new Fake<IFormulaExpressionFactory>();
//            _operationFactoryFake = new Fake<IArithmeticOperationFactory>();
//            _operatorsFake = new Fake<IEvaluatorStack<string>>();
//            _expressionsFake = new Fake<IEvaluatorStack<Expression>>();

//            _processor = new FormulaTokenProcessor(_tokenProcessorsFake.FakedObject, _formulaProcessorFake.FakedObject, _formulaReaderFake.FakedObject,
//              _expressionFactoryFake.FakedObject, _operationFactoryFake.FakedObject);
//        }

//        public class Constructor : FormulaTokenProcessorFixture
//        {
//            [Fact]
...
//                Invoking(() =>
//                    {
//                        _processor = new FormulaTokenProcessor(null, _formulaProcessorFake.FakedObject, _formulaReaderFake.FakedObject,
//                            this.CreateStub<IFormulaExpressionFactory>(), this.CreateStub<IArithmeticOperationFactory>());
//                    })
//                    .Should()
...
//                Invoking(() =>
//                    {
//                        _processor = new FormulaTokenProcessor(CreateMany<FormulaTokenProcessorContext>().AsList(), null,
...
//                Invoking(() =>
//                    {
//                        _processor = new FormulaTokenProcessor(CreateMany<FormulaTokenProcessorContext>().AsList(),
...
//                            null, this.CreateStub<IArithmeticOperationFactory>());
//                    })
//                    .Should()
//                    .Throw<ArgumentNullException>()
...
//                        _processor = new FormulaTokenProcessor(CreateMany<FormulaTokenProcessorContext>().AsList(),
//                            _formulaProcessorFake.FakedObject, _formulaReaderFake.FakedObject,
//                            this.CreateStub<IFormulaExpressionFactory>(), null);
//                    })
//                    .Should()
//                    .Throw<ArgumentNullException>()
...
//                  .CallsTo(fake => fake.Add(A<FormulaTokenProcessorContext>.Ignored))
//                  .MustHaveHappened(6, Times.Exactly);
//            }
//        }

//        public class Constructor_RegisterTokenProcessors : FormulaTokenProcessorFixture
//        {
//            public Constructor_RegisterTokenProcessors()
//            {
//                _processor = new FormulaTokenProcessor(_formulaProcessorFake.FakedObject, _formulaReaderFake.FakedObject,
//                  _expressionFactoryFake.FakedObject, _operationFactoryFake.FakedObject);
//            }
...
//        public class ProcessOperators : FormulaTokenProcessorFixture
//        {
//            [Fact]
//            public void Should_Throw_When_Operators_Null()
//            {
//                Invoking(() => _processor.ProcessOperators(null, this.CreateStub<IEvaluatorStack<Expression>>(), () => false))
//                    .Should()
//                    .Throw<ArgumentNullException>()
...
//            {
//                Invoking(() => _processor.ProcessOperators(this.CreateStub<IEvaluatorStack<string>>(), null, () => false))
//                    .Should()
//                    .Throw<ArgumentNullException>()
...
//            {
//                Invoking(() => _processor.ProcessOperators(this.CreateStub<IEvaluatorStack<string>>(), this.CreateStub<IEvaluatorStack<Expression>>(), null))
//                    .Should()
//                    .Throw<ArgumentNullException>()
...
//                var operations = CreateMany<ArithmeticOperation>(3);
...
//            {
//                var nextOperator = Create<string>();
//                var operation = Create<ArithmeticOperation>();
...
//        public class ProcessToken : FormulaTokenProcessorFixture
//        {
//            [Fact]
...
//                var context1 = new FormulaTokenProcessorContext(
//                  (t, u) => t == token,
//                  (t, u) =>
//                  {
//                      invoked1 = true;
...
//                var context2 = new FormulaTokenProcessorContext(
//                  (t, u) => t == token,
//                  (t, u) =>
//                  {
//                      invoked2 = true;
...
//                var tokenProcessors = new List<FormulaTokenProcessorContext> { context1, context2 };

//                _processor = new FormulaTokenProcessor(tokenProcessors, _formulaProcessorFake.FakedObject, _formulaReaderFake.FakedObject,
//                  _expressionFactoryFake.FakedObject, _operationFactoryFake.FakedObject);
...
//                var tokenProcessors = new List<FormulaTokenProcessorContext> { context1 };
