...
namespace AllOverIt.Evaluator.Tests.Stack
{
    public class EvaluatorStackFixture : AoiFixtureBase
    {
        ...
        public EvaluatorStackFixture()
        {
            _stack = new EvaluatorStack<string>();
        }

        public class Constructor_Default : EvaluatorStackFixture
        {
            [Fact]
        ...
        public class Constructor_Enumerable : EvaluatorStackFixture
        {
            [Fact]
            public void Should_Throw_When_Enumerable_Null()
            {
                Invoking(() => _stack = new EvaluatorStack<string>(null))
                    .Should()
            ...
            public void Should_Contain_Provided_Elements()
            {
                ...
                _stack = new EvaluatorStack<string>(items);
        ...
        public class Count : EvaluatorStackFixture
        {
            [Fact]
        ...
        public class Contains : EvaluatorStackFixture
        {
        ...
        public class Clear : EvaluatorStackFixture
        {
            [Fact]
        ...
        public class Any : EvaluatorStackFixture
        {
            [Fact]
        ...
        public class Peek : EvaluatorStackFixture
        {
            [Fact]
        ...
        public class Pop : EvaluatorStackFixture
        {
            [Fact]
            public void Should_Throw_When_Stack_Empty()
            {
        ...
        public class Push : EvaluatorStackFixture
        {
            [Fact]
        ...
        public class ToArray : EvaluatorStackFixture
        {
            [Fact]
        ...
        public class GetEnumerator : EvaluatorStackFixture
        {
            [Fact]
