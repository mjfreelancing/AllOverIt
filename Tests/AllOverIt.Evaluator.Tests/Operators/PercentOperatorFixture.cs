...
namespace AllOverIt.Evaluator.Tests.Operators
{
    public class PercentOperatorFixture : FixtureBase
    {
        ...
        public class Constructor : PercentOperatorFixture
        {
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new PercentOperator(null, this.CreateStub<Expression>()))
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new PercentOperator(this.CreateStub<Expression>(), null))
