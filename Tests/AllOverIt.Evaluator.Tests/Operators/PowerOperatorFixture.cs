...
namespace AllOverIt.Evaluator.Tests.Operators
{
    public class PowerOperatorFixture : FixtureBase
    {
        ...
        public class Constructor : PowerOperatorFixture
        {
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new PowerOperator(null, this.CreateStub<Expression>()))
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new PowerOperator(this.CreateStub<Expression>(), null))
