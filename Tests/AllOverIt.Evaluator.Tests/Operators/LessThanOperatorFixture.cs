...
namespace AllOverIt.Evaluator.Tests.Operators
{
    public class LessThanOperatorFixture : FixtureBase
    {
        ...
        public class Constructor : LessThanOperatorFixture
        {
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new LessThanOperator(null, this.CreateStub<Expression>()))
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new LessThanOperator(this.CreateStub<Expression>(), null))
