...
namespace AllOverIt.Evaluator.Tests.Operators
{
    public class MaxOperatorFixture : FixtureBase
    {
        ...
        public class Constructor : MaxOperatorFixture
        {
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new MaxOperator(null, this.CreateStub<Expression>()))
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new MaxOperator(this.CreateStub<Expression>(), null))
