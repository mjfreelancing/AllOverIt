...
namespace AllOverIt.Evaluator.Tests.Operators
{
    public class MultiplyOperatorFixture : FixtureBase
    {
        ...
        public class Constructor : MultiplyOperatorFixture
        {
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new MultiplyOperator(null, this.CreateStub<Expression>()))
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new MultiplyOperator(this.CreateStub<Expression>(), null))
