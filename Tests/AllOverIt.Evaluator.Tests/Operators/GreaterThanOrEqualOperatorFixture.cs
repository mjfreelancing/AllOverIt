...
namespace AllOverIt.Evaluator.Tests.Operators
{
    public class GreaterThanOrEqualOperatorFixture : FixtureBase
    {
        ...
        public class Constructor : GreaterThanOrEqualOperatorFixture
        {
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new GreaterThanOrEqualOperator(null, this.CreateStub<Expression>()))
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new GreaterThanOrEqualOperator(this.CreateStub<Expression>(), null))
