...
namespace AllOverIt.Evaluator.Tests.Operators
{
    public class GreaterThanOperatorFixture : FixtureBase
    {
        ...
        public class Constructor : GreaterThanOperatorFixture
        {
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new GreaterThanOperator(null, this.CreateStub<Expression>()))
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new GreaterThanOperator(this.CreateStub<Expression>(), null))
