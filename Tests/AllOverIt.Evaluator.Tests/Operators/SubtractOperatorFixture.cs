...
namespace AllOverIt.Evaluator.Tests.Operators
{
    public class SubtractOperatorFixture : FixtureBase
    {
        ...
        public class Constructor : SubtractOperatorFixture
        {
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new SubtractOperator(null, this.CreateStub<Expression>()))
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new SubtractOperator(this.CreateStub<Expression>(), null))
