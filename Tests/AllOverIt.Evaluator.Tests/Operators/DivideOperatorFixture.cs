...
namespace AllOverIt.Evaluator.Tests.Operators
{
    public class DivideOperatorFixture : FixtureBase
    {
        ...
        public class Constructor : DivideOperatorFixture
        {
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new DivideOperator(null, this.CreateStub<Expression>()))
            ...
            {
                Should.Throw<ArgumentNullException>(() => _operator = new DivideOperator(this.CreateStub<Expression>(), null))
