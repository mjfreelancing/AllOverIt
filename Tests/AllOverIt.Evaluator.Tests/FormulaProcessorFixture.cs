...
//        private readonly Fake<IFormulaExpressionFactory> _formulaExpressionFactoryFake;
//        private readonly Fake<IFormulaTokenProcessor> _tokenProcessorFake;
...
//            _operatorStackFake = new Fake<IEvaluatorStack<string>>();
//            _expressionStackFake = new Fake<IEvaluatorStack<Expression>>();
//            _operationFactoryFake = new Fake<IArithmeticOperationFactory>();
//            _formulaExpressionFactoryFake = new Fake<IFormulaExpressionFactory>();
//            _tokenProcessorFake = new Fake<IFormulaTokenProcessor>();
...
//            _formulaProcessor = new FormulaProcessor(_operatorStackFake.FakedObject, _expressionStackFake.FakedObject, _formulaExpressionFactoryFake.FakedObject,
...
//            {
//                FormulaProcessor.CustomTokens.UserMethod.Should().Be("$$");
//            }

//            [Fact]
//            public void Should_Define_Custom_Token_UnaryMinus()
//            {
//                FormulaProcessor.CustomTokens.UnaryMinus.Should().Be("##");
//            }
...
//                Invoking(() =>
//                    {
//                        _formulaProcessor = new FormulaProcessor(null, _expressionStackFake.FakedObject, _formulaExpressionFactoryFake.FakedObject,
...
//                Invoking(() =>
//                    {
//                        _formulaProcessor = new FormulaProcessor(_operatorStackFake.FakedObject, null, _formulaExpressionFactoryFake.FakedObject,
//                            _operationFactoryFake.FakedObject, _userDefinedMethodFactoryFake.FakedObject,
//                            (p, r, e, o) => _tokenProcessorFake.FakedObject);
//                    })
//                    .Should()
...
//                Invoking(() =>
//                    {
//                        _formulaProcessor = new FormulaProcessor(_operatorStackFake.FakedObject, _expressionStackFake.FakedObject, null,
//                            _operationFactoryFake.FakedObject, _userDefinedMethodFactoryFake.FakedObject,
//                            (p, r, e, o) => _tokenProcessorFake.FakedObject);
//                    })
//                    .Should()
...
//                Invoking(() =>
//                    {
//                        _formulaProcessor = new FormulaProcessor(_operatorStackFake.FakedObject, _expressionStackFake.FakedObject,
...
//                  .CallsTo(fake => fake.RegisterOperation(FormulaProcessor.CustomTokens.UnaryMinus, 4, 1, A<Func<Expression[], IOperator>>.Ignored))
//                  .MustHaveHappened(1, Times.Exactly);
//            }
...
//                Func<IFormulaProcessor, IFormulaReader, IFormulaExpressionFactory, IArithmeticOperationFactory, IFormulaTokenProcessor>
//                  factory = (p, r, e, o) =>
//                {
//                    created = true;
...
//        public class PushOperator : FormulaProcessorFixture
//        {
//            [Fact]
...
//        public class PushExpression : FormulaProcessorFixture
//        {
...
//        public class ProcessScopeStart : FormulaProcessorFixture
//        {
...
//                _operatorStackFake
//                  .CallsTo(fake => fake.Push(FormulaProcessor.CustomTokens.OpenScope))
//                  .MustHaveHappened(1, Times.Exactly);
//            }
//        }

//        public class ProcessScopeEnd : FormulaProcessorFixture
//        {
...
//                _operatorStackFake
//                  .CallsTo(fake => fake.Peek())
//                  .Returns(FormulaProcessor.CustomTokens.OpenScope);
...
//                _operatorStackFake
//                  .CallsTo(fake => fake.Peek())
//                  .Returns(FormulaProcessor.CustomTokens.UserMethod);
...
//                _operatorStackFake
//                  .CallsTo(fake => fake.Peek())
//                  .Returns(FormulaProcessor.CustomTokens.OpenScope); // anything other than UserMethod
...
//        public class ProcessMethodArgument : FormulaProcessorFixture
//        {
...
//        public class ProcessOperator : FormulaProcessorFixture
//        {
...
//                _operatorStackFake
//                  .CallsTo(fake => fake.Push(FormulaProcessor.CustomTokens.UnaryMinus))
//                  .MustHaveHappened(1, Times.Exactly);
//            }
...
//                var currentOperation = new ArithmeticOperation(1, 1, e => this.CreateStub<IOperator>());
//                var peekedOperation = new ArithmeticOperation(0, 1, e => this.CreateStub<IOperator>());
...
//                var currentOperation = new ArithmeticOperation(1, 1, e => this.CreateStub<IOperator>());
//                var peekedOperation = new ArithmeticOperation(1, 1, e => this.CreateStub<IOperator>());
...
//                var currentOperation = new ArithmeticOperation(1, 1, e => this.CreateStub<IOperator>());
//                var peekedOperation = new ArithmeticOperation(2, 1, e => this.CreateStub<IOperator>());
...
//        public class ProcessNumerical : FormulaProcessorFixture
//        {
...
//        public class ProcessNamedOperand : FormulaProcessorFixture
//        {
...
//                _operatorStackFake
//                  .CallsTo(fake => fake.Push(FormulaProcessor.CustomTokens.UserMethod))
//                  .MustHaveHappened(1, Times.Exactly);
//            }
...
//                var operation = new ArithmeticOperationDummy(expressionsRequired);
