...
namespace AllOverIt.Validation.Tests.Validators
{
    public partial class ValidatorsFixture
    {
        public class IsGreaterThanOrEqualTo : ValidatorsFixture
        {
            ...
            private class DummyComparisonGreaterThanOrEqualToExplicitValidator : ValidatorBase<DummyDto>
            {
            ...
            private class DummyComparisonGreaterThanOrEqualToContextValidator : ValidatorBase<DummyDto>
            {
                public DummyComparisonGreaterThanOrEqualToContextValidator()
                {
                    // nullable and non-nullable, context provided comparison value
                    RuleFor(model => model.Value5).IsGreaterThanOrEqualTo<DummyDto, int, ComparisonContext>(ctx => ctx.CompareTo);
                    RuleFor(model => model.Value6).IsGreaterThanOrEqualTo<DummyDto, int, ComparisonContext>(ctx => ctx.CompareTo);
                }
            }
            ...
            public void Should_Fail_Validate_Explicit()
            {
                ...
                var expected = new[]
                {
                    new
                    {
                        ...
                        ErrorMessage = $"'{nameof(DummyDto.Value3)}' must be greater than or equal to 0."
                    },
                    new
                    {
                        ...
                        ErrorMessage = $"'{nameof(DummyDto.Value4)}' must be greater than or equal to 0."
                    }
                };
            ...
            public void Should_Fail_Validate_Context()
            {
                ...
                var expected = new[]
                {
                    new
                    {
                        ...
                        ErrorMessage = $"'{nameof(DummyDto.Value5)}' must be greater than or equal to {comparison.CompareTo}."
                    },
                    new
                    {
                        ...
                        ErrorMessage = $"'{nameof(DummyDto.Value6)}' must be greater than or equal to {comparison.CompareTo}."
                    }
                };
